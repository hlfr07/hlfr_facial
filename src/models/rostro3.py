...
VIDEO_PATH = "video.mp4"   # o 0 webcam

INPUT_SIZE = (320, 320)
CONF_THRESHOLD = 0.7   # 2.5g necesita menos threshold
NMS_THRESHOLD = 0.4
...
for stride in FEAT_STRIDES:
    ...
    ANCHORS[stride] = generate_anchors(fh, fw, stride)
